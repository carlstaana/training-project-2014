...
<body>
	<a href="#edit-productCategory" class="skip" tabindex="-1"><g:message
	...
	<div id="edit-productCategory" class="content scaffold-edit"
		...
		<g:form url="[resource:productCategoryInstance, action:'update']"
			method="PUT">
			<g:hiddenField name="version"
				value="${productCategoryInstance?.version}" />
			<fieldset class="form">
