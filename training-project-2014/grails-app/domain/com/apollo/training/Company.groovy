...
class Company {
	...
	static constraints = {
		...
		technicalPhone(blank:false,nullable:false,matches:/\d{3}-\d{7}/)
		technicalFax(blank:true,nullable:true,matches:/\d{3}-\d{7}/)
		...
		administrationPhone(blank:false,nullable:false,matches:/\d{3}-\d{7}/)
		administrationFax(blank:true,nullable:true,matches:/\d{3}-\d{7}/)
		...
		salesMarketingPhone(blank:false,nullable:false,matches:/\d{3}-\d{7}/)
		salesMarketingFax(blank:true,nullable:true,matches:/\d{3}-\d{7}/)
